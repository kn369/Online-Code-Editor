...
// node_modules/@carefully-coded/react-text-gradient/dist/esm/index.js
...
var a = function() {
  return a = Object.assign || function(t2) {
    for (var e, r = 1, a2 = arguments.length; r < a2; r++)
      for (var o2 in e = arguments[r])
        Object.prototype.hasOwnProperty.call(e, o2) && (t2[o2] = e[o2]);
    return t2;
  }, a.apply(this, arguments);
};
var o = { WebkitBackgroundClip: "text", MozBackgroundClip: "text", MozTextFillColor: "transparent", WebkitTextFillColor: "transparent", display: "inline-block", backgroundPositionX: "right", backgroundPositionY: "top" };
function n(t2) {
  return "radial" == t2.type ? "radial-gradient(farthest-corner at top, ".concat(t2.from, ", ").concat(t2.to, ")") : "linear-gradient(".concat(t2.degree, "deg, ").concat(t2.from, ", ").concat(t2.to, ")");
}
function i(i2) {
  var l, d, c, p, u = i2.gradient, g = i2.animate, y = i2.animateTo, f = i2.animateDuration, m = function(t2, e) {
    var r = {};
    for (var a2 in t2)
      Object.prototype.hasOwnProperty.call(t2, a2) && e.indexOf(a2) < 0 && (r[a2] = t2[a2]);
    if (null != t2 && "function" == typeof Object.getOwnPropertySymbols) {
      var o2 = 0;
      for (a2 = Object.getOwnPropertySymbols(t2); o2 < a2.length; o2++)
        e.indexOf(a2[o2]) < 0 && Object.prototype.propertyIsEnumerable.call(t2, a2[o2]) && (r[a2[o2]] = t2[a2[o2]]);
    }
    return r;
  }(i2, ["gradient", "animate", "animateTo", "animateDuration"]);
  if (null == u.degree && (u.degree = 90), null == u.type && (u.type = "radial"), g && null == y && (y = { type: u.type, to: u.from, from: u.to }), y && (null == y.type && (y.type = u.type), u.type !== y.type))
    throw new Error("@carefully-coded/react-text-gradient: cannot animate between linear and radial gradients");
  var b = n(u), s = { loop: { reverse: true }, from: { backgroundPosition: "radial" == u.type ? "0% 75%" : "auto", backgroundImage: b, backgroundSize: "radial" == u.type ? "150% 150%" : "auto" }, to: { backgroundPosition: "radial" == u.type ? "0% 75%" : "auto", backgroundImage: b, backgroundSize: "radial" == u.type ? "150% 150%" : "auto" }, config: { duration: null != f ? f : 4e3 } };
  y && (s.to = { backgroundImage: n({ degree: null !== (l = y.degree) && void 0 !== l ? l : u.degree, from: null !== (d = y.from) && void 0 !== d ? d : u.from, to: null !== (c = y.to) && void 0 !== c ? c : u.to, type: null !== (p = y.type) && void 0 !== p ? p : u.type }), backgroundPosition: "radial" == u.type ? "100% 25%" : "auto", backgroundSize: "radial" == u.type ? "150% 150%" : "auto" });
  var k = useSpring(s);
  return import_react15.default.createElement(animated.div, a({}, m, { style: a(a(a({}, o), k), m.style) }));
}
export {
  i as default
};
//# sourceMappingURL=@carefully-coded_react-text-gradient.js.map
