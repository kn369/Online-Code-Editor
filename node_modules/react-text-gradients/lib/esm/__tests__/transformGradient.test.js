...
import { toGradientStyle, toLinearStyle, toRadialStyle, directions, defaultStyles, } from '../helpers';
describe('transformGradient function', () => {
    test.each(directions)('should transform linear gradient into valid inline css', dir => {
